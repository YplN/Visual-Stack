class Stack {
  ...
  show() {
    ...
    stroke(DRAW_COLOR);
    strokeWeight(3);
    line(this.x - this.w, this.y - this.hItem / 2 + 3, this.x + this.w, this.y - this.hItem / 2 + 3);

    if (this.values.length > 0) {
      line(this.x - this.w / 2 - 3, this.y - this.hItem / 2, this.x - this.w / 2 - 3, this.y - this.values.length * this.hItem + this.hItem / 2);
      line(this.x + this.w / 2 + 3, this.y - this.hItem / 2, this.x + this.w / 2 + 3, this.y - this.values.length * this.hItem + this.hItem / 2);
    }
